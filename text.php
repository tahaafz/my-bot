...
$textbotlang['users']['sell']['None-credit'] = "🚨 موجودی حساب کاربری شما کافی نمی باشد ابتدا باید حساب خود را شارژ کنید

📝 برای شارژ حساب کاربری خود یکی از روش های پرداخت زیر را انتخاب کنید";
$textbotlang['users']['sell']['ErrorConfig'] = "❌ خطایی در ساخت اشتراک رخ داده است، لطفاً مجدد امتحان کنید.";
...
$textbotlang['users']['extend']['error'] = "❌ خطایی رخ داده است، لطفاً مجدد امتحان کنید.";
...
همچنین میتوانید با ایدی زیر در ارتباط باشید:
    @oboradmin";
...
$textbotlang['users']['Balance']['priceinput'] = "💸برای افزایش موجودی مبلغ را به تومان وارد کنید:
✅ حداقل مبلغ واریزی 500,000 و حداکثر مبلغ 3,000,000 تومان می باشد";
$textbotlang['users']['Balance']['priceinput2'] = "❌موجودی کافی نمی باشد
💸برای افزایش موجودی مبلغ را به تومان وارد کنید:
✅ حداقل مبلغ واریزی 500,000 و حداکثر مبلغ 3,000,000 تومان می باشد";
$textbotlang['users']['Balance']['errorprice'] = "❌ خطا
💬 لطفا مبلغ واریزی را مشخص کنید
برای مثال: 500000
اعداد به صورت لاتین باشد و مبلغ به تومان وارد شود";
$textbotlang['users']['Balance']['errorpricelimit'] = "❌ خطا
💬 مبلغ وارد شده معتبر نیست.
حداقل مبلغ شارژ ۵۰۰,۰۰۰ تومان و حداکثر ۳,۰۰۰,۰۰۰ تومان می‌باشد.";
...
$textbotlang['users']['Balance']['payments'] = "💵 دریافت شماره کارت";
$textbotlang['users']['Balance']['payments2'] = "💵 دریافت شماره کارت(خودکار)";
$textbotlang['users']['Balance']['payments3'] = "💵 دریافت شماره کارت(با تاخیر)";
...
$textbotlang['users']['Balance']['Confirmpaying']  = "✅ واریز کردم"
;$textbotlang['users']['Balance']['Send-receipt'] ="✅ رسید شما دریافت شد. پس از بررسی نتیجه اطلاع داده می‌شود.";
$textbotlang['users']['Balance']['Send-receipt2'] ="🚀 پس از تایید رسید شما در ربات ترونادو کیف پول شما به صورت خودکار شارژ خواهد شد";
...
$textbotlang['users']['removeconfig']['btnremoveuser'] = "📷 دریافت QR CODE";
